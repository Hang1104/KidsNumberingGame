...
public class DescendingOrderGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        instructionText.text = "Order the numbers from largest to smallest.";
    ...
    void OnButtonClick(int number)
    {
        ...
        if (buttonsClickedQ4 == 9)
        {
            ...
            for (int i = 0; i < dropZones.Count; i++)
            {
                ...
                if (dropZoneText.text != (9 - i).ToString())
                {
